...
void AES_OFB_encrypt_file(const char* input_filename, const char* output_filename, unsigned char w[Nb * (Nr + 1)][4], unsigned char iv[16]) {
...
void AES_OFB_decrypt_file(const char* input_filename, const char* output_filename, unsigned char w[Nb * (Nr + 1)][4], unsigned char iv[16]) {
    FILE* input_file = fopen(input_filename, "rb");
    FILE* output_file = fopen(output_filename, "wb");
